            ...
            <div className="container mx-auto">
              <div className="flex flex-col md:flex-row items-start px-5 ">
                <div className=" md:w-7/12 ">
                  <img
                    src={dancer1}
                    className=" md:w-10/12 md:h-[500px] mx-auto mt-5 md:mt-0"
                    alt=""
                  />
                </div>
              ...
              <div className="flex flex-col-reverse md:flex-row items-start px-5 ">
                <div className="md:w-7/12 mt-5 md:mt-20">
                  ...
                  <p className="text-gray-900 dark:text-[#dfdee0] w-full md:w-8/12 lg:w-7/12 font-[500] md:my-8">
                    Start your first journey with us. We are always ready to
                    welcome you. We have the ability to make you great. We have
                    the best dancing Instructors/ Guru all over the world. We
                    can Learn all kinds of forms of dance here.
                  </p>
                ...
                <div className=" md:w-5/12 ">
                  <img
                    src={dancer2}
                    className=" w-10/12 md:h-[500px] mx-auto mt-5 md:mt-0"
                    alt=""
                  />
                </div>
              </div>
